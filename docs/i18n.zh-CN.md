...
当使用 Angular [应用本地化方案](https://angular.cn/guide/i18n) 时，可以根据 [LOCALE_ID](https://angular.dev/api/core/LOCALE_ID) 自动切换 `ng-zorro-antd` 默认语言
