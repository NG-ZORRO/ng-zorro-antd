...
@Component({
  template: `
    @switch (useSuite) {
      ...
      @case (2) {
        <nz-date-picker nzMode="year" [nzOpen]="nzOpen"></nz-date-picker>
      }

      <!-- Suite 3 -->
      @case (3) {
        <nz-date-picker nzMode="year" nzOpen [(ngModel)]="modelValue"></nz-date-picker>
      }
      ...
      @case (5) {
        <nz-year-picker nzOpen [(ngModel)]="modelValue"></nz-year-picker>
      }
    }
  `
})
