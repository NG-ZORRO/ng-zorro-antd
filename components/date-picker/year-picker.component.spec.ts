...
describe('NzYearPickerComponent', () => {
  ...
  describe('general api testing', () => {
    ...
    it('should support nzDisabledDate', fakeAsync(() => {
      fixture.detectChanges();
      const compareDate = new Date('2016-11-15 00:00:00');
      ...
      tick(500);
      fixture.detectChanges();
      const allDisabledCells = overlayContainerElement.querySelectorAll('tbody.ant-calendar-year-panel-tbody tr td.ant-calendar-year-panel-cell-disabled');
      const disabledCell = allDisabledCells[ allDisabledCells.length - 1 ];
      expect(disabledCell.textContent).toContain('2016');
    }));
    ...
    it('should support nzOnChange', fakeAsync(() => {
      fixtureInstance.nzValue = new Date('2018');
      const nzOnChange = spyOn(fixtureInstance, 'nzOnChange');
      fixture.detectChanges();
      dispatchMouseEvent(getPickerTrigger(), 'click');
      fixture.detectChanges();
      ...
      const cell = getFirstYearCell(); // Use the first cell
  ...
  describe('ngModel value accesors', () => {
    ...
    it('should specified date provide by "modelValue" be choosed', fakeAsync(() => {
      fixtureInstance.modelValue = new Date('2018');
      fixture.detectChanges();
  ...
  function getFirstYearCell(): HTMLElement {
    return queryFromOverlay('tbody.ant-calendar-year-panel-tbody td.ant-calendar-year-panel-cell:not(.ant-calendar-year-panel-last-decade-cell)') as HTMLElement;
  }
