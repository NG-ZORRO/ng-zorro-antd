...
describe('NzDatePickerComponent', () => {
  ...
  describe('general api testing', () => {
    ...
    it('should support nzAllowClear and work properly', fakeAsync(() => {
      ...
      const initial = fixtureInstance.nzValue = new CandyDate();
      ...
      fixture.detectChanges();
      expect(fixtureInstance.nzValue).toBe(initial);
      expect(nzOnChange).toHaveBeenCalledWith({ date: null, dateString: '' });
      expect(debugElement.query(clearBtnSelector)).toBeFalsy();
    }));
    ...
    it('should support nzDisabled', fakeAsync(() => {
      ...
      fixtureInstance.nzAllowClear = true;
      fixtureInstance.nzValue = new CandyDate();
    ...
    it('should support nzDisabledDate', fakeAsync(() => {
      ...
      fixtureInstance.nzValue = new CandyDate('2018-11-11 12:12:12');
    ...
    it('should support nzDefaultValue', () => {
      fixtureInstance.nzDefaultValue = new CandyDate('2018-11-11');
      fixture.detectChanges();
      dispatchMouseEvent(getPickerTrigger(), 'click');
      fixture.detectChanges();
    ...
    it('should support nzValue', () => {
      fixtureInstance.nzValue = new CandyDate('2018-11-11');
      fixture.detectChanges();
      dispatchMouseEvent(getPickerTrigger(), 'click');
      fixture.detectChanges();
      expect(getSelectedDayCell().textContent.trim()).toBe('11');
    ...
    it('should support nzOnChange', () => {
      ...
      expect(result.date.getDate()).toBe(+cellText);
    });
  ...
  describe('panel switch and move forward/afterward', () => {
    ...
    it('should support month panel changes', () => {
      fixtureInstance.nzValue = new CandyDate('2018-11-11');
      fixture.detectChanges();
      openPickerByClickTrigger();
      ...
      fixture.detectChanges();
      expect(queryFromOverlay('.ant-calendar-header .ant-calendar-month-panel')).toBeTruthy();
    ...
    it('should support year panel changes', () => {
      fixtureInstance.nzValue = new CandyDate('2018-11-11');
      fixture.detectChanges();
      openPickerByClickTrigger();
      ...
      fixture.detectChanges();
      expect(queryFromOverlay('.ant-calendar-header .ant-calendar-year-panel')).toBeTruthy();
    ...
    it('should support decade panel changes', () => {
      ...
      fixture.detectChanges();
      expect(queryFromOverlay('.ant-calendar-header .ant-calendar-decade-panel')).toBeTruthy();
      // Coverage for last/next cell
  ...
  describe('specified date picker testing', () => {
    ...
    it('should support nzShowTime', fakeAsync(() => {
      const nzOnChange = spyOn(fixtureInstance, 'nzOnChange');
      fixtureInstance.nzValue = new CandyDate('2018-11-11 11:22:33');
      ...
      tick();
      fixture.detectChanges();
      expect(queryFromOverlay('.ant-calendar-time-picker-inner.ant-calendar-time-picker-column-3')).toBeTruthy();
    ...
    it('should support nzShowTime.nzFormat', fakeAsync(() => {
      ...
      tick();
      fixture.detectChanges();
      expect(queryFromOverlay('.ant-calendar-time-picker-inner.ant-calendar-time-picker-column-2')).toBeTruthy();
    }));

    it('should support nzDisabledTime and nzShowTime.nzHideDisabledOptions', fakeAsync(() => {
      fixtureInstance.nzShowTime = true;
      fixtureInstance.nzDisabledTime = (current: CandyDate) => {
        return {
    ...
    it('should support nzShowToday', () => {
      fixture.detectChanges();
      openPickerByClickTrigger();
      expect(overlayContainerElement.querySelector('.ant-calendar-footer')).toBeFalsy();

      fixtureInstance.nzShowToday = true;
      fixture.detectChanges();
      expect(overlayContainerElement.querySelector('.ant-calendar-today-btn ')).toBeTruthy();
      ...
      fixture.detectChanges();
      const result = nzOnChange.calls.allArgs()[0][0];
      expect(result.date.isSame(new CandyDate(), 'day')).toBeTruthy();
    ...
    it('should support nzMode', () => {
      ...
      fixture.detectChanges();
      openPickerByClickTrigger();
      expect(overlayContainerElement.querySelector('.ant-calendar-header .ant-calendar-month-panel')).toBeTruthy();
    });
  ...
  describe('ngModel value accesors', () => {
    ...
    it('should specified date provide by "modelValue" be choosed', fakeAsync(() => {
      fixtureInstance.modelValue = new CandyDate('2018-11-11');
      fixture.detectChanges();
