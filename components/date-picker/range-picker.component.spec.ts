...
@Component({
  template: `
    @switch (useSuite) {
      ...
      @case (2) {
        <nz-range-picker [nzOpen]="nzOpen"></nz-range-picker>
      }

      <!-- Suite 3 -->
      @case (3) {
        <nz-range-picker nzOpen [(ngModel)]="modelValue"></nz-range-picker>
      }
      ...
      @case (6) {
        <nz-range-picker [nzSeparator]="separatorTemplate"></nz-range-picker>
      }
