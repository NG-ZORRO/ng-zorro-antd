...
import { HijriCalendarFooterComponent } from './hijri-calendar-footer.component';
import { DatePickerService } from '../date-picker.service';
import { HijriInnerPopupComponent } from './hijri-inner-popup.component';
import {
  CompatibleDate,
  DisabledDateFn,
  DisabledTimeFn,
...
@Component({
  ...
  selector: 'hijri-date-range-popup',
  ...
  `,
  imports: [HijriInnerPopupComponent, NgTemplateOutlet, HijriCalendarFooterComponent]
})
export class HijriDateRangePopupComponent implements OnInit, OnChanges {
