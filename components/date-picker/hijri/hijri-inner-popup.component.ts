...
import { HijriLibPackerModule } from './lib/hijri-lib-packer.module';

@Component({
  // eslint-disable-next-line @angular-eslint/component-selector
  selector: 'hijri-inner-popup',
  ...
  `,
  imports: [HijriLibPackerModule, NzTimePickerModule, FormsModule]
})
export class HijriInnerPopupComponent implements OnChanges {
  ...
  onChooseMonth(value: CandyDate): void {
    this.activeDate = new CandyDate(
      this.dateAdapter.setMonth(this.activeDate.nativeDate, this.dateAdapter.getMonth(value.nativeDate))
    );
  ...
  onChooseQuarter(value: CandyDate): void {
    this.activeDate = new CandyDate(
      this.dateAdapter.setQuarter(this.activeDate.nativeDate, this.dateAdapter.getQuarter(value.nativeDate))
    );
    this.value = value;
    this.selectDate.emit(value);
  }
  ...
  onChooseYear(value: CandyDate): void {
    this.activeDate = new CandyDate(
      this.dateAdapter.setYear(this.activeDate.nativeDate, this.dateAdapter.getYear(value.nativeDate))
    );
