...
import { HijriDatePickerService } from './hijri-date-picker.service';
import { HijriDateRangePopupComponent } from './hijri-date-range-popup.component';
import { NzHijriRangePickerComponent } from './hijri-range-picker.component';
import {
  CompatibleDate,
  DisabledTimeFn,
  NzDateMode,
...
@Component({
  selector:
    'nz-hijri-date-picker,nz-hijri-week-picker,nz-hijri-month-picker,nz-hijri-quarter-picker,nz-hijri-year-picker,nz-hijri-range-picker',
  exportAs: 'nzHijriDatePicker',
  ...
  providers: [
    NzHijriDateAdapter,
    { provide: NzDateAdapter, useExisting: NzHijriDateAdapter },
    HijriDatePickerService,
    { provide: DatePickerService, useExisting: HijriDatePickerService },
    { provide: NZ_SPACE_COMPACT_ITEM_TYPE, useValue: 'picker' },
    {
      provide: NG_VALUE_ACCESSOR,
      multi: true,
      useExisting: forwardRef(() => NzHijriDatePickerComponent)
    }
  ],
  imports: [
    FormsModule,
...
export class NzHijriDatePickerComponent implements OnInit, OnChanges, AfterViewInit, ControlValueAccessor {
  ...
  isRange = !!inject(NzHijriRangePickerComponent, { self: true, optional: true }); // Indicate whether the value is a range value
  ...
  @ViewChild(HijriDateRangePopupComponent, { static: false }) panel?: HijriDateRangePopupComponent;
