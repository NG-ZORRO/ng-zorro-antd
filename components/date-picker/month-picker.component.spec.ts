...
@Component({
  template: `
    @switch (useSuite) {
      ...
      @case (2) {
        <nz-date-picker nzMode="month" [nzOpen]="nzOpen"></nz-date-picker>
      }

      <!-- Suite 3 -->
      @case (3) {
        <nz-date-picker nzMode="month" nzOpen [(ngModel)]="modelValue"></nz-date-picker>
      }
      ...
      @case (5) {
        <nz-month-picker nzOpen></nz-month-picker>
      }
    }
  `
})
