...
export class NzEmptyService<T = any> {
  ...
  constructor(
    ...
    this.nzConfigService.getConfigChangeEventForComponent('nzEmpty').subscribe(() => {
  ...
  private getUserDefaultEmptyContent(): Type<T> | TemplateRef<string> | string | undefined {
    return (
      (this.nzConfigService.config.nzEmpty || { nzDefaultEmptyContent: undefined }).nzDefaultEmptyContent ||
