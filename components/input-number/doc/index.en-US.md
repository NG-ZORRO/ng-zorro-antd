...
| ------------------- | ---------------------------------------------------------------------------------------------- | -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ------- |
| `[ngModel]`         | current value, two way binding                                                                 | `number \| string`                                       | -                                                                                                                                   |
...
| `[nzStringMode]`    | Set value as string to support high precision decimals, `ngModelChange` will return a `string` | `boolean`                                                | `false`                                                                                                                             |         |
...
| `(ngModelChange)`   | callback function when the value changes                                                       | `EventEmitter<number \| string>`                         | -                                                                                                                                   |
