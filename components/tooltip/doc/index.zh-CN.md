...
在 tooltip 相关(包括 popconfirm popover) 的组件使用中，body 的滚轴事件会刷新 tooltip 的位置。如果是自定义容器的滚轴事件则不会刷新，你可以使用 [NzScrollingComponent](https://ng.ant.design/components/scrolling/zh) 组件以达到该目的。
