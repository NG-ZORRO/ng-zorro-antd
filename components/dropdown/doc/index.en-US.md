...
| `[nzTriggerDelay]`     | the delay time before the dropdown menu is shown, can be set separately for `click` and `hover`   | `number \| Partial<{ click: number; hover: number }>`                                       | `150`          |
