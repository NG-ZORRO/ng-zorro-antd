...
const PREVIEW_SRC = 'https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png?preview';
const QUICK_SRC =
...
describe('Preview', () => {
  ...
  describe('ImagePreview', () => {
    ...
    it('should preview src work', fakeAsync(() => {
      context.firstSrc = QUICK_SRC;
      context.previewSrc = PREVIEW_SRC;
      fixture.detectChanges();
      const image = debugElement.nativeElement.querySelector('img');
      image.click();
      tickChanges();
      ...
      expect(previewImage.getAttribute('src')).toBe(PREVIEW_SRC);
    }));
  });
...
@Component({
  template: `
    <nz-image-group>
      <img nz-image [nzSrc]="firstSrc" [nzDisablePreview]="disablePreview" [nzPreviewSrc]="previewSrc" />
      <img nz-image [nzSrc]="secondSrc" [nzDisablePreview]="disablePreview" [nzPreviewSrc]="previewSrc" />
    </nz-image-group>
    <img nz-image [nzSrc]="firstSrc" [nzDisablePreview]="disablePreview" [nzPreviewSrc]="previewSrc" />
  `
})
