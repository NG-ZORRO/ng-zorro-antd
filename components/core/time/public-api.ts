...
export type { NzDateFnsAdapterConfig, NzDateFnsAdapterConfigFactory } from './date-fns-adapter';
export { NativeDateAdapter, provideNzNativeDateAdapter } from './native-adapter';
export type { NzNativeDateAdapterConfig, NzNativeDateAdapterConfigFactory } from './native-adapter';
