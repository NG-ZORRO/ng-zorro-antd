  ...
  template: `
    <nz-typography>
      ...
      <p nz-paragraph>
        ...
        refined by Ant UED Team, which aims to <span nz-text><strong>uniform the user interface specs for internal
        background projects, lower the unnecessary cost of design differences and implementation and liberate the
        resources ofdesign and front-end development</strong></span>.
      </p>
      <h2 nz-title>Guidelines and Resources</h2>
      <p nz-paragraph>
        We supply a series of design principles, practical patterns and high quality design resources
        (<span nz-text><code>Sketch</code></span> and
        <span nz-text><code>Axure</code></span>), to help people create their product
      ...
      <p nz-paragraph>
        ...
        基于<span nz-text><mark>『确定』和『自然』</mark></span>的设计价值观，通过模块化的解决方案，降低冗余的生产成本，
        让设计者专注于<span nz-text><strong>更好的用户体验</strong></span>。
      </p>
      <h2 nz-title>
        设计资源
      </h2>
      <p nz-paragraph>
        ...
        （<span nz-text><code>Sketch</code></span> 和 <span nz-text><code>Axure</code></span>），来帮助业务快速设计出高质
        量的产品原型。
      </p>
      <nz-typography>
        <ul>
