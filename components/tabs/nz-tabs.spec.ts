...
@Component({
  ...
  template: `
    <nz-tabset [nzEnableRoute]="true" [nzQueryParam]="'tabs'">
      <nz-tab nzTitle="Zero">I have no param.</nz-tab>
      <nz-tab nzTitle="One" nzPathOrParam="one">I have a param One. Try refresh this page and you will see me again!</nz-tab>
