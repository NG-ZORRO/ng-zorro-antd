...
function finishInit(fixture: ComponentFixture<NzTestTreeViewVirtualScrollWithLevelAccessorComponent>): void {
...
export class NzTestTreeViewVirtualScrollWithLevelAccessorComponent implements OnInit {
  ...
  minBufferPx = 30 * 2;
  maxBufferPx = 30 * 4;
  compareBy: ((value: FlatNode) => NzSafeAny) | null = (value: FlatNode): NzSafeAny => value;
