...
| `[nzCenter]`    | This property aligns the flex box both vertically and horizontally. It is equivalent to setting `align-items: center;` and `justify-content: center;` on the flex container. | `boolean`                                                                                     | `false`    |
