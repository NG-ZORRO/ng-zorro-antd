...
| `[nzSize]`          | Avatar size; use the `xs`, `sm`, `md`, `lg`, `xl`, `xxl`, and `xxxl` breakpoints to configure responsive sizes in pixels                                        | `'large' \| 'small' \| 'default' \| number \| { xs: number, sm: number, ... }` | `'default'` | ✅            | responsive object: 22.1.0 |
