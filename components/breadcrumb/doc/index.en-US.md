...
| `[nzRouteDataBreadcrumbLabel]` | Custom route Data breadcrumb config label, used with `nzAutoGenerate` is `true` | `string` | `'breadcrumb'` |
...
use `[nzRouteDataBreadcrumbLabel]` to custom `data` breadcrumb label:
