...
describe('breadcrumb', () => {
  ...
  describe('auto generated', () => {
    ...
    it('should route data breadcrumb label work', fakeAsync(() => {
      TestBed.configureTestingModule({
        imports: [CommonModule, NzBreadCrumbModule, RouterTestingModule.withRoutes(customBreadcrumbLabelRoutes)],
        declarations: [NzBreadcrumbRouteDataBreadcrumbLabelDemoComponent, NzBreadcrumbNullComponent]
      }).compileComponents();

      fixture = TestBed.createComponent(NzBreadcrumbRouteDataBreadcrumbLabelDemoComponent);
      breadcrumb = fixture.debugElement.query(By.directive(NzBreadCrumbComponent));
      ...
      fixture.ngZone!.run(() => {
        ...
        // Should nzRouteDataBreadcrumbLabel value is 'customBreadcrumb'
        flushFixture(fixture);
        expect(breadcrumb.componentInstance.nzRouteDataBreadcrumbLabel).toBe('customBreadcrumb');
...
class NzBreadcrumbRouteDataBreadcrumbLabelDemoComponent {}
...
const customBreadcrumbLabelRoutes: Routes = [
  {
    path: 'one',
    component: NzBreadcrumbRouteDataBreadcrumbLabelDemoComponent,
    data: {
      customBreadcrumb: ''
    },
    children: [
