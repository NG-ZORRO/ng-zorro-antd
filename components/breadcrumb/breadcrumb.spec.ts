...
describe('breadcrumb', () => {
  ...
  describe('auto generated', () => {
    ...
    it('should template work', fakeAsync(() => {
      TestBed.configureTestingModule({
        imports: [CommonModule, NzBreadCrumbModule, RouterTestingModule.withRoutes(customRouteLabelRoutes)],
        declarations: [NzBreadcrumbRouterLabelWithTemplateComponent, NzBreadcrumbNullComponent]
      }).compileComponents();

      fixture = TestBed.createComponent(NzBreadcrumbRouterLabelWithTemplateComponent);
      breadcrumb = fixture.debugElement.query(By.directive(NzBreadCrumbComponent));
...
@Component({
  template: `
    <nz-breadcrumb nzAutoGenerate [nzRouteLabel]="'customBreadcrumb'"></nz-breadcrumb>
    <router-outlet></router-outlet>
  `
})
...
@Component({
  template: `
    <nz-breadcrumb nzAutoGenerate [nzRouteLabel]="'customBreadcrumb'" [nzRouteLabelFn]="labelFn"></nz-breadcrumb>
    <router-outlet></router-outlet>
  `
})
