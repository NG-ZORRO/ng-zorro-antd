...
import { NzFilterOptionType, NzSelectItemInterface } from './select.types';

describe('select', () => {
  describe('default mode', () => {
    let testBed: ComponentBed<TestSelectDefaultComponent>;
    let component: TestSelectDefaultComponent;
    let fixture: ComponentFixture<TestSelectDefaultComponent>;
    let selectElement!: HTMLElement;
    beforeEach(() => {
      testBed = createComponentBed(TestSelectDefaultComponent, { imports: [NzSelectModule, NzIconTestModule, FormsModule] });
  ...
  describe('multiple mode', () => {
    ...
    let component: TestSelectMultipleComponent;
    let fixture: ComponentFixture<TestSelectMultipleComponent>;
    let selectElement!: HTMLElement;
    beforeEach(() => {
      testBed = createComponentBed(TestSelectMultipleComponent, { imports: [NzSelectModule, NzIconTestModule, FormsModule] });
      component = testBed.component;
      fixture = testBed.fixture;
      selectElement = testBed.debugElement.query(By.directive(NzSelectComponent)).nativeElement;
    });
  ...
  describe('tags mode', () => {
    let testBed: ComponentBed<TestSelectTagsComponent>;
    let component: TestSelectTagsComponent;
    let fixture: ComponentFixture<TestSelectTagsComponent>;
    let selectElement!: HTMLElement;
    beforeEach(() => {
      testBed = createComponentBed(TestSelectTagsComponent, { imports: [NzSelectModule, NzIconTestModule, FormsModule] });
      component = testBed.component;
      fixture = testBed.fixture;
      selectElement = testBed.debugElement.query(By.directive(NzSelectComponent)).nativeElement;
    });
...
export class TestSelectMultipleComponent {
