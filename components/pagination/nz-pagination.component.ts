...
export class NzPaginationComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.i18n$ = this.i18n.localeChange.subscribe(() => {
      this.locale = {
        prev_page: this.i18n.translate('Pagination.prev_page'),
        next_page: this.i18n.translate('Pagination.next_page'),
        prev_5: this.i18n.translate('Pagination.prev_5'),
        next_5: this.i18n.translate('Pagination.next_5'),
        items_per_page: this.i18n.translate('Pagination.items_per_page'),
        jump_to: this.i18n.translate('Pagination.jump_to'),
        page: this.i18n.translate('Pagination.page')
      };
    });
  }
