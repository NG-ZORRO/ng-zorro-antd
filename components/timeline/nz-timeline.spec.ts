...
describe('timeline', () => {
  ...
  describe('custom color timeline', () => {
    ...
    it('should support custom color', () => {
      fixture.detectChanges();
      expect(items[0].nativeElement.querySelector('.ant-timeline-item-head').style.borderColor).toBe('gray');
...
@Component({
  template: `
    <nz-timeline>
      <nz-timeline-item [nzColor]="'gray'">Create a services site 2015-09-01</nz-timeline-item>
