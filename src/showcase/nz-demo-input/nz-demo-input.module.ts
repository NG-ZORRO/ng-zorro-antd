...
import { NzDemoInputDirectiveComponent } from './nz-demo-input-directive.component';
...
@NgModule({
  ...
  declarations: [ NzDemoInputComponent, NzDemoInputBasicComponent, NzDemoInputSizeComponent, NzDemoInputAddOnComponent, NzDemoInputGroupComponent, NzDemoInputSearchComponent, NzDemoInputTextareaComponent, NzDemoInputTextareaAutoSizeComponent, NzDemoInputAffixComponent, NzDemoInputDirectiveComponent ]
})
