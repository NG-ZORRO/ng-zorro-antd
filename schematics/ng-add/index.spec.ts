...
describe('ng-add schematic', () => {
  ...
  it('should update package.json', async () => {
    ...
    // TODO: tree.readJson() + ignore @typescript-eslint/no-explicit-any
  ...
  it('should add hammerjs import to project main file', async () => {
    ...
    const fileContent = tree.readContent(normalize(join(project.sourceRoot, 'main.ts')));
  ...
  it('should required modules', async () => {
    const options = {...defaultOptions};
    const tree = await runner.runSchematic('ng-add-setup-project', options, appTree);
    const fileContent = tree.readContent('/projects/ng-zorro/src/app/app.module.ts');
